...
export function MyEdit({ user_id }) {
  ...
  useEffect(()=>{
      axios.get('http://192.168.50.76:8000/member/userinfo/' + user_id)
      .then(res => {
        setForm({
          ...form,
          user_id : user_id,
        ...
        if (res.data.user_img) {
          setProfileView(res.data.user_img ? 'http://192.168.50.76:8000/getimg/userprofile/' + res.data.user_img : null) 
        }
      })
      .catch((err)=>{
        console.log(err);
  ...
  const changePassword = () => {
    ...
    axiosAuth({
      url : 'http://192.168.50.76:8000/mypage/edit/pw',
      method : 'post',
  ...
  const handleSubmit = (e) => {
    ...
    axiosAuth({
      url : 'http://192.168.50.76:8000/mypage/edit/userinfo',
      method : 'post',
      data : body
    })
    .then(res => {
  ...
  const quitMember = () => {
    axiosAuth({
      url : 'http://192.168.50.76:8000/mypage/quit',
      method : 'delete',
      data : {user_id}
    })
    .then(res => {
